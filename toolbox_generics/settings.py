...
# Retrieve secret from a file 'secrets.json'
...
ROOT_URLCONF = 'toolbox_generics.urls'
...
WSGI_APPLICATION = 'toolbox_generics.wsgi.application'
...
OAUTH_TOKEN_ENDPOINT = BASE_URL + '/token/'
